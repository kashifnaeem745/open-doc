...
// disk (inspector edits, comment markers, design writes, dev API mutations)
// never touch the committed fixture sources. node_modules is symlinked back to
// the fixture's install.
